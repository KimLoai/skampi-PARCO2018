...
skampi_pure: Makefile.dep $(MEASUREMENTS)
	make -f Makefile.dep MPICC="$(MPICC)" CFLAGS="$(CFLAGS)" skampi_pure

skampi_profiler: Makefile.dep $(MEASUREMENTS)
	make -f Makefile.dep MPICC="$(MPICC)" CFLAGS="$(CFLAGS)" skampi_profiler
...
clean:
	rm -f $(OBJECTS) $(MEASUREMENTOBJECTS) skampi_pure skampi_profiler
