 ...
 *    onesided.c bug.c pt2pt.c demo.c io.c helpers.c delayed.c coll.c localio.c mmisc.c node2node.c datatypes.c
 * in directory 
 *    measurements
...
extern double measure_MPI_IO_read_file_once( int size, char*api, int directio_flag );
extern void init_MPI_IO_read_file_once( int size, char*api, int directio_flag );
extern void finalize_MPI_IO_read_file_once(int size, char*api, int directio_flag );
extern double measure_MPI_IO_read_large_file_once( int power );
extern void init_MPI_IO_read_large_file_once( int power );
extern void finalize_MPI_IO_read_large_file_once(int power );
...
extern double measure_MPI_IO_write_file_once( int size, char*api, int create_flag, int directio_flag );
extern void init_MPI_IO_write_file_once( int size, char*api, int create_flag, int directio_flag );
extern void finalize_MPI_IO_write_file_once(int size, char*api, int create_flag, int directio_flag );
extern double measure_MPI_IO_write_large_file_once( int power, int create_flag );
extern void init_MPI_IO_write_large_file_once( int power, int create_flag );
extern void finalize_MPI_IO_write_large_file_once(int power, int create_flag );
...
static void call_measure_MPI_IO_read_file_once( struct variable *result, struct variable par[] )
{ store_double( result, measure_MPI_IO_read_file_once( par[0].u.intv, par[1].u.stringv, par[2].u.intv )); }

static void call_init_MPI_IO_read_file_once( struct variable *result, struct variable par[] )
{ init_MPI_IO_read_file_once( par[0].u.intv, par[1].u.stringv, par[2].u.intv ); }

static void call_finalize_MPI_IO_read_file_once( struct variable *result, struct variable par[] )
{ finalize_MPI_IO_read_file_once( par[0].u.intv, par[1].u.stringv, par[2].u.intv ); }

static void call_measure_MPI_IO_read_large_file_once( struct variable *result, struct variable par[] )
{ store_double( result, measure_MPI_IO_read_large_file_once( par[0].u.intv )); }

static void call_init_MPI_IO_read_large_file_once( struct variable *result, struct variable par[] )
{ init_MPI_IO_read_large_file_once( par[0].u.intv ); }

static void call_finalize_MPI_IO_read_large_file_once( struct variable *result, struct variable par[] )
{ finalize_MPI_IO_read_large_file_once( par[0].u.intv ); }
...
static void call_measure_MPI_IO_write_file_once( struct variable *result, struct variable par[] )
{ store_double( result, measure_MPI_IO_write_file_once( par[0].u.intv, par[1].u.stringv, par[2].u.intv, par[3].u.intv )); }

static void call_init_MPI_IO_write_file_once( struct variable *result, struct variable par[] )
{ init_MPI_IO_write_file_once( par[0].u.intv, par[1].u.stringv, par[2].u.intv, par[3].u.intv ); }

static void call_finalize_MPI_IO_write_file_once( struct variable *result, struct variable par[] )
{ finalize_MPI_IO_write_file_once( par[0].u.intv, par[1].u.stringv, par[2].u.intv, par[3].u.intv ); }

static void call_measure_MPI_IO_write_large_file_once( struct variable *result, struct variable par[] )
{ store_double( result, measure_MPI_IO_write_large_file_once( par[0].u.intv, par[1].u.intv )); }

static void call_init_MPI_IO_write_large_file_once( struct variable *result, struct variable par[] )
{ init_MPI_IO_write_large_file_once( par[0].u.intv, par[1].u.intv ); }

static void call_finalize_MPI_IO_write_large_file_once( struct variable *result, struct variable par[] )
{ finalize_MPI_IO_write_large_file_once( par[0].u.intv, par[1].u.intv ); }
...
void init_functions(void)
{
  ...
  insert_function( &call_init_MPI_IO_read_file_once, &call_measure_MPI_IO_read_file_once, &call_finalize_MPI_IO_read_file_once, "MPI_IO_read_file_once", "isi", TYPE_DOUBLE );
  insert_function( &call_init_MPI_IO_read_large_file_once, &call_measure_MPI_IO_read_large_file_once, &call_finalize_MPI_IO_read_large_file_once, "MPI_IO_read_large_file_once", "i", TYPE_DOUBLE );
  ...
  insert_function( &call_init_MPI_IO_write_file_once, &call_measure_MPI_IO_write_file_once, &call_finalize_MPI_IO_write_file_once, "MPI_IO_write_file_once", "isii", TYPE_DOUBLE );
  insert_function( &call_init_MPI_IO_write_large_file_once, &call_measure_MPI_IO_write_large_file_once, &call_finalize_MPI_IO_write_large_file_once, "MPI_IO_write_large_file_once", "ii", TYPE_DOUBLE );
